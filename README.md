...
- Φτιάξαμε την Product και την Year μέσα στην domain
- Οι δύο κλάσεις "συνδέονται" άτυπα με πεδία
  - > Κάθε προιόν έχει ένα λεξικό με χρονιές για κλειδιά, και τιμή έχει την αξία εκείνη την χρονιά
  - > Κάθε χρονιά έχει ένα λεξικό με προιόντα για κλειδιά, και τιμή έχει την αξία εκείνγ την χρονιά

ΤΟ-DO:
1) Ολοκληρώνω την Υear
